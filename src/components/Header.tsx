...
function Header() {
  ...
  return (<header className='bg-primary flex sm:flex-row flex-col'>
    <div className='sm:w-1/2 m-10'>
      ...
      <p className='text-white'>At once an emblem of Old New York and a relative newcomer, Gage & Tollner was revived well over a century after first opening at this location in 1892. A trio of Brooklyn hospitality pros, including chef Sohui Kim, reopened the august institution to quick acclaim in 2021.</p>
